...
$endows = pdo_query("select * from endow");
if(isset($_POST['check'])){
$clent_name= $_POST['clent_name'];
$clent_phone= $_POST['clent_phone'];
$clent_email= $_POST['clent_email'];
$client_dx= $_POST['client_dx'];
$check_endow = $_POST['endow'];
$check = 0;
foreach ($endows as $key => $code) {
    $CodeEndow = $code['CodeEndow'];
    var_dump($CodeEndow);
    if (isset($check_endow)) {
        if ($CodeEndow == $check_endow) {
            $check = 1;
        }
    }
}
if($check == 0){
    $tb_endow = "Mã ưu đãi sai";
}
if($clent_name == ""){
...
// $AmountEndow = pdo_query_one("select * from endow where CodeEndow = $check_endow");
// if($AmountEndow - 1 < 0 ){
//     $tb_endow = "Mã ưu đãi không khả dụng"; 
// }
// if(!isset($tb_endow)){
//     $sql = "update endow AmountEndow = $AmountEndow set   where CodeEndow = $check_endow";
// }
if (!isset($clent_email_er) && !isset($clent_phone_er) && !isset($clent_name_er) && !isset($clent_dx_er) && ($check==1 || $check_endow == "")) {
    $updateAmount = "update endow AmountEndow = $AmountEndow set where CodeEndow = $check_endow";
    ...
    <div class="content">
        ...
        <div class="bk_login">
            <div class="d-flex">
                ...
                <div class="ms-4">
                    <h3 aria-level="3" dir="auto" role="heading" class="" style="color: rgb(3, 18, 26);">Đăng nhập và
                        tận hưởng ưu đãi dành riêng cho thành viên</h3>
                    ...
                    <div class="mt-2">
                        <div class="" style="opacity: 1;">
                            <a href="index.php?action=login" class=""
                                style="color: rgb(1, 148, 243);font-size:18px;font-weight:700;">Đăng nhập</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                data-parent="#accordionExample">
                                <form class="card-body payment-card-body mb-5 mt-4" method="POST"
                                    action="<?php if(isset($next)){echo"/index.php?action=pay";}?>">

                                    <span class="font-weight-normal card-text">Họ và tên</span>
                                    <div class="input mb-3">
                                        <input type="text" class="form-control  mt-2"
                                            value="<?php if (isset($clent_name)) {echo $clent_name;}?>"
                                            name="clent_name" placeholder="Full Name...">
                                        <p
                                            style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                                    ...
                                    <div class="row mt-4 mb-3 ">
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="input">
                                                <input type="number" class="form-control mt-2"
                                                    value="<?php if (isset($clent_phone)) {echo $clent_phone;}?>"
                                                    name="clent_phone" placeholder="Number phone...">
                                                <p
                                                    style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input">
                                                <input type="text" class="form-control  mt-2" name="clent_email"
                                                    value="<?php if (isset($clent_email)) {echo $clent_email;}?>"
                                                    placeholder="Email...">
                                                <p
                                                    style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                                        ...
                                        <br><br>
                                        <div class="col-md-6">
                                            <span class="font-weight-normal card-text">Mã khuyến mãi của bạn (Nếu
                                                có)</span>
                                            <div class="input">
                                                <input type="text" class="form-control mt-3" name="endow"
                                                    value="<?php if (isset($check_endow)) {echo $check_endow;}?>"
                                                    placeholder="Nhập mã ưu đãi....">
                                                <p
                                                    style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                                                    <?php if(isset($tb_endow)){echo$tb_endow;} ?></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="ps-3 pe-3 pb-3">
                        ...
                        <div class="d-flex mt-4 ">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p style="font-size: 12px;" class="text-muted">Loại vé: <span
                                        style="font-weight: 600;"><?= $ticket_type['name'] ?></span></p>
                                <p style="font-size: 12px;" class="text-muted">Chuyến đi: <span
                                        style="font-weight: 600;"><?= $ticket['round_trip']==2 ? "Khứ hồi" :"Một Chiều" ?></span>
                                </p>
                                <p style="font-size: 12px;" class="text-muted">Mã Chuyến bay: <span
