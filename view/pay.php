                        ...
                        <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                            ...
                            <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3 p-2">
                                <li class="nav-item"> <a data-toggle="pill" href="#credit-card"
                                        class="nav-link active "> <i class="fas fa-credit-card mr-2"></i> Thẻ Tín Dụng
                                    </a> </li>
                            ...
                            <div class="tab-pane fade show active pt-3">
                                <form role="form" onsubmit="event.preventDefault()">
                                    <div class="form-group"> <label for="username">
                                            <h6>Tên Thẻ</h6>
                                        </label> <input type="text" name="username" placeholder="Tên Chủ Thẻ" required
                                            class="form-control "> </div>
                                    <div class="form-group"> <label for="cardNumber">
                                            <h6>Số Thẻ</h6>
                                        </label>
                                        <div class="input-group"> <input type="text" name="cardNumber"
                                                placeholder="Số Thẻ" class="form-control " required>
                                    ...
                                    <div class="card-footer"> <button type="button"
                                            class="subscribe btn btn-primary btn-block shadow-sm"> Thanh Toán </button>
                                </form>
                            </div>
                        </div> <!-- End -->
                        <!-- Paypal info -->
                            ...
                            <div class="form-group mt-3">
                                <form action="index.php?action=thanhtoanvpay" method="POST">
                                    <p> <button type="submit" name="redirect" id="redirect" class="btn btn-primary "><i
                                                class="fas fa-mobile-alt mr-2"></i> Tiến hành thanh toán</button> </p>
                                </form>
                            </div>
                            <p class="text-muted mt-3">Lưu ý: Sau khi nhấp vào nút, bạn sẽ được chuyển đến một cổng
                                thanh toán an toàn. Sau khi hoàn tất quá trình thanh toán, bạn sẽ được chuyển hướng trở
                                lại trang web để xem chi tiết đơn hàng của mình. </p>
                        </div>
                        <div class="tab-pane fade pt-3">
                            <div class="form-group "> <label for="Select Your Bank">
                                </label>
                            ...
                            <div class="form-group mt-3">
                                <form action="index.php?action=thanhtoanmomo" method="POST">
                                    <p> <button type="submit" name="redirect" id="redirect" class="btn btn-primary "><i
                                                class="fas fa-mobile-alt mr-2"></i> Thanh toán qua mã QR</button> </p>
                                </form><br><br>
                    ...
                    <div class="d-flex mt-4 ">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="mt-2 mb-2 d-flex justify-content-between" style="font-size: 14px;">
                                <span>SĐT:</span> <span style="font-weight: 600;"> 0<?=$booking['tell']?>
                            </p>
