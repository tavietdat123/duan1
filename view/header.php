                ...
                <?php if ($boolean) : ?>
                    <div class="d-flex align-items-center logo__item_user">
                        ...
                        <div class="logo__item  d-flex align-items-center">
                            <div class="ms-2">
                                <img class="logo_item_avt" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLhlPE0gXGOoAq3qU3GHKSS2Ih3VQDLzZ6GQ&usqp=CAU" alt="" />
                            </div>
                            <div>
                            </div>
        ...
        <div class="nav_main d-flex flex-column">
            ...
            <div class="nav_3 d-flex flex-column">
                ...
                <a href="index.php?action=trips" class="nav_link <?php if (isset($_GET['action']) && ($_GET['action']) == "trips") {
                                                                        echo "active";
                                                                    } ?>"><i class="fa-solid fa-plane-departure"></i><span>Các Chuyến Bay</span></a>
            
                <button class="nav_link test1 <?php if (isset($_GET['action']) && ($_GET['action']) == "history") {
                                                                        echo "active";
                                                                    } ?>"><i class="fa-solid fa-clock-rotate-left"></i><span>Lịch sử đặt vé</span></button>
            </div>
        </div>
    </header>
    <script>
