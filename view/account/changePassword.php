    ...
    <div class="login_contnet">
        ...
        <div class="login_form">
            ...
            <form action="./changePassword.php" method="post" class=" d-flex flex-column">
                ...
                <input type="password" placeholder="Nhập Password..." name="password_dk"
                    value="<?php if(isset($password_dk)){echo$password_dk;}?>">
                <p style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                    <?php if(isset($errormk)){echo$errormk;} ?></p>
                <input type="password" placeholder="Nhập Re-Password..." name="re_password_dk"
                    value="<?php if(isset($re_password_dk)){echo$re_password_dk;}?>">
                <p style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300">
                    <?php if(isset($errorremk)){echo$errorremk;} ?></p>
