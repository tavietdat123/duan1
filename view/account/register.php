    ...
    <div class="login_contnet">
        ...
        <div class="login_form">
            ...
            <form action="index.php?action=register" method="post" class=" d-flex flex-column">
                ...
                <input type="text" placeholder="Nhập Fullname..." name='username_dk' value="<?php if (isset($username_dk)) {
                    echo $username_dk;
                } ?>">
                <p style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300"><?php if (isset($errorusn)) {
                 echo $errorusn;
                } ?></p>
                <input type="password" placeholder="Nhập Password..." name="password_dk" value="<?php if (isset($password_dk)) {
                echo $password_dk;
                } ?>">

                <p style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300"><?php if (isset($errormk)) {
                echo $errormk;
                } ?></p>
                <input type="password" placeholder="Nhập Re-Password..." name="re_password_dk" value="<?php if (isset($re_password_dk)) {
                 echo $re_password_dk;
                } ?>">
                <p style="color: red;margin-left:2px;margin-top:2px ; font-size: 12px; font-weight: 300"><?php if (isset($errorremk)) {
                echo $errorremk;
                } ?></p>
            ...
            <div class="register_sp d-flex justify-content-between mt-4 mb-1">
                <p>Bằng việc đăng ký, bạn đã đồng ý với Momondo về <br> <a href="">điều khoản dịch vụ</a> & <a
